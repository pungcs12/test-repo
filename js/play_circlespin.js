var play_circlespin_State = {
    create: function() {
        ...
        this.circlespin_wheel = game.add.sprite(game.world.centerX-50, game.world.centerY, 'Circlepin_Wheel');
        ...
        this.btn_circlewheel_spin_stop =false;
        this.my_angle = 30;
    },
    update: function(){
        if(this.btn_circlewheel_spin){
            this.circlespin_wheel.angle += this.my_angle;
        }
        
        if(this.btn_circlewheel_spin_stop){
    ...
    btn_circlewheel_spin: function(){
        this.btn_circlewheel_spin = true;
        this.btn_circlewheel_spin_stop = false;
        this.my_angle = 30;
    },
        
    btn_circlewheel_spin_stop: function(){
        this.btn_circlewheel_spin_stop = true;
        //this.btn_circlewheel_spin = false;
